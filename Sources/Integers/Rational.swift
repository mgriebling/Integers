...
public struct Rational : Codable, Sendable, Hashable {
    ...
    public init(_ a: (Integer, Integer)) { self.init(numerator: a.0, denominator: a.1) }
    ...
    static private func normalize (_ n: Integer, _ d: Integer) -> (Integer, Integer) {
        let gcd = n.gcd(d)
        if gcd != 1 { return (n / gcd, d / gcd) }
        return (n, d)
    }
    
    public func normalize (_ n: Integer, _ d: Integer) -> Self { Self(Self.normalize(n, d)) }
    
    public func isEqual (_ n: Self) -> Bool { self.n == n.n && self.d == n.d }
    
    /// a/b < c/d => ad < bc
    public func isLessThan (_ n: Self) -> Bool { self.n * n.d < self.d * n.n }
    
    /// a/b + c/d = (ad + bc) / bd
    public func add (_ b: Self) -> Self { normalize(n * b.d + b.n * d, d * b.d) }
    
    /// a/b * c/d = ac/bd
    public func mul (_ b: Self) -> Self { normalize(n * b.n, d * b.d) }

    public func div (_ b: Self) -> Self { self.mul(b.reciprocal) }
    
    /// (a/b)^n = a^n / b^n
    public func power (_ n: Integer) -> Self { Self(numerator:self.n ** n, denominator:self.d ** n) }
    
	public var reciprocal : Self { Self(numerator: d, denominator: n) }
	public var negate : Self { Self(numerator: -n, denominator: d) }
	public var abs    : Self { Self(numerator: n.abs, denominator: d) }
